...
| 89 | [History-free quota](./89-history-free-quota.md) | 🔴 NOT STARTED (design only) | 86, 33, GC-purge cron | quota = live bytes; history rides free; stuffing bound K×cap; **pro retention 90→365 FIXED (this branch)** |
