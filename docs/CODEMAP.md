...
src/cli/sync-git/held-skip.ts        — design-174 stable held-attempt input observation, exact consulted-reflog binding, eligibility, safety-floor, and kill-switch helpers. Never: follow/ref mutation, BASE composition, or state persistence.
