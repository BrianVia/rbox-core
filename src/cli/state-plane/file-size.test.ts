...
const ALLOWED: ReadonlyMap<string, string> = new Map([
  ...
  ["src/engine/git/capture.ts", "pending split — 402 nonblank lines when #606's supersession-ordering fix merged from main"],
...
const RATCHET: ReadonlyMap<string, { nonblank: number; bytes: number }> = new Map([
  ...
  ["src/engine/git/capture.ts", { nonblank: 402, bytes: 22578 }],
