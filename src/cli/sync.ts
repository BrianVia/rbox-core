export { EntryCapGuardError, MassDeleteGuardError, TrustedViewRefusalError, pushMassDeleteTrips, makeDeferErrnoReporter, filesFirstFlagEnabled, type TrustedLocalView } from "./sync/policy.js";
