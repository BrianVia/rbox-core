...
import { OP_STATE_CLASSIFICATION, OP_STATE_DIRS, OP_STATE_FILES, isSyncableRef, type OpStateRoot } from "../../engine/manifest-validate.js";
import type { GitArtifactRef } from "../../engine/types.js";
import { HEX40, exists, headBranchOf, moveFileAtomic, walkFiles } from "./git-state.js";
import { git, gitStatus } from "../../engine/git-spawn.js";

interface SyncableRefMap {
  [ref: string]: string;
}

function parseAllRefs(out: string): SyncableRefMap {
  const refs: SyncableRefMap = {};
