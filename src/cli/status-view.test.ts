...
test("deletion-pending gets its deliberate display slot without changing legacy ties", () => {
  ...
  // Design 273 C2: a durable conflict outranks the self-healing slot. Telling
  // the reader "a sync stopped partway through" about a repo that also needs a
  // decision is how a repo needing one disappears from every attention surface.
